...
[Files]
Source: "..\dist\BitCapIPR\bitcap-ipr\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\BitCapIPR\bitcap-ipr\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
