...
"}")
        ...
        self.minButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
...
"")
        ...
        self.titlebar.setGeometry(QtCore.QRect(0, 0, 350, 40))
        self.titlebar.setObjectName("titlebar")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.titlebar)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget = QtWidgets.QWidget(parent=self.titlebar)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.titleIcon = QtWidgets.QToolButton(parent=self.widget)
        self.titleIcon.setObjectName("titleIcon")
        ...
        self.minButton = QtWidgets.QToolButton(parent=self.widget)
        self.minButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.minButton.setObjectName("minButton")
        self.horizontalLayout.addWidget(self.minButton)
        self.closeButton = QtWidgets.QToolButton(parent=self.widget)
        self.closeButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.closeButton.setObjectName("closeButton")
    ...
    def retranslateUi(self, IPRConfirmation):
        ...
        self.titleIcon.setText(_translate("IPRConfirmation", "..."))
        self.title.setText(_translate("IPRConfirmation", "IP Confirmation"))
        self.title.setProperty("StyleClass", _translate("IPRConfirmation", "setText"))
        self.minButton.setText(_translate("IPRConfirmation", "..."))
        self.closeButton.setText(_translate("IPRConfirmation", "..."))
