...
"}")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 90, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Maximum)
        ...
        self.menuOptions.addAction(self.actionEnableIDTable)
