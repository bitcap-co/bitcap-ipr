...
"}")
        ...
        self.actionCreateNetwork = QtWidgets.QPushButton(parent=self.header2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.actionCreateNetwork.sizePolicy().hasHeightForWidth())
        self.actionCreateNetwork.setSizePolicy(sizePolicy)
        self.actionCreateNetwork.setObjectName("actionCreateNetwork")
        self.horizontalLayout_8.addWidget(self.actionCreateNetwork)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCreateNetwork.setText(_translate("MainWindow", "Create New Network"))
