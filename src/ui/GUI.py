...
"}")
        ...
        self.IPRButtonStart = QtWidgets.QPushButton(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        self.IPRButtonStart.setFont(font)
        self.IPRButtonStart.setDefault(True)
        self.IPRButtonStart.setObjectName("IPRButtonStart")
        self.gridLayout.addWidget(self.IPRButtonStart, 3, 1, 1, 1)
        self.IPRButtonStop = QtWidgets.QPushButton(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        self.IPRButtonStop.setFont(font)
        self.IPRButtonStop.setObjectName("IPRButtonStop")
        self.gridLayout.addWidget(self.IPRButtonStop, 3, 3, 1, 1)
        ...
        self.actionAutoOpenIP = QtGui.QAction(parent=MainWindow)
        self.actionAutoOpenIP.setCheckable(True)
        self.actionAutoOpenIP.setObjectName("actionAutoOpenIP")
        self.actionQuit = QtGui.QAction(parent=MainWindow)
        self.actionQuit.setObjectName("actionQuit")
        self.menuAbout.addAction(self.actionHelp)
        self.menuAbout.addAction(self.actionVersion)
        self.menuOptions.addAction(self.actionAutoOpenIP)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.IPRButtonStop.setText(_translate("MainWindow", "Stop"))
        self.IPRButtonStart.setText(_translate("MainWindow", "Start"))
        ...
        self.actionAutoOpenIP.setText(_translate("MainWindow", "Auto Open IP in Chrome"))
...
"}")
        ...
        self.macField = QtWidgets.QLineEdit(parent=IPRConfirmation)
        self.macField.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        self.macField.setFont(font)
        self.macField.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.macField.setObjectName("macField")
        self.gridLayout.addWidget(self.macField, 4, 0, 1, 1)
        self.ipField = QtWidgets.QLineEdit(parent=IPRConfirmation)
        self.ipField.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ipField.setFont(font)
        self.ipField.setFrame(True)
        self.ipField.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.ipField.setObjectName("ipField")
        self.gridLayout.addWidget(self.ipField, 1, 0, 1, 1)
        ...
        self.openChrome = QtWidgets.QPushButton(parent=IPRConfirmation)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.openChrome.sizePolicy().hasHeightForWidth())
        self.openChrome.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.openChrome.setFont(font)
        self.openChrome.setObjectName("openChrome")
        self.gridLayout.addWidget(self.openChrome, 2, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
    ...
    def retranslateUi(self, IPRConfirmation):
        ...
        self.macField.setText(_translate("IPRConfirmation", "Test"))
        self.ipField.setText(_translate("IPRConfirmation", "192.168.2.15"))
        ...
        self.openChrome.setText(_translate("IPRConfirmation", "Open Chrome"))
