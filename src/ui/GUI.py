...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAutoStartOnLaunch.setToolTip(_translate("MainWindow", "Automatically start listeners on launch (Takes effect on next launch)"))
        ...
        self.actionEnableIDTable.setToolTip(_translate("MainWindow", "Stores IP,MAC,SERIAL,TYPE,SUBTYPE in a table on confirmation"))
