...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.idTable.sizePolicy().hasHeightForWidth())
        self.idTable.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.configTabs.sizePolicy().hasHeightForWidth())
        self.configTabs.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.checkEnableSysTray.sizePolicy().hasHeightForWidth())
        self.checkEnableSysTray.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.checkVnishUseAntminerLogin.sizePolicy().hasHeightForWidth())
        self.checkVnishUseAntminerLogin.setSizePolicy(sizePolicy6)
